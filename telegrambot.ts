...
export class Telegram {
  ...
  async sendMessage(payload: {
    ...
    return await this.baseRequest('sendMessage', payload)
  }
  ...
  async replyMessage(payload: {
    ...
    return await this.baseRequest('sendMessage', {
  ...
  private async baseRequest(method: string, body: any): Promise<any> {
